...
public class MovieRunner {
    public static void main(String[] args) {
        ...
        /*
            the Comparator.comparing accepts a Function (functional interface that has 1 parameter and a return type) then the comparing method returns a Comparator, which the sort method needs
         */
